...
class ACL(AcsDataBase):
    ...
    Acl: Mapped[int] = mapped_column('Acl', default=0)
    Tz: Mapped[int] = mapped_column('Tz', default=0)
    DGrp: Mapped[int] = mapped_column('DGrp', default=0)
...
class AclGrp(AcsDataBase):
    ...
    Dev: Mapped[int] = mapped_column('Dev', primary_key=True, default=0)
    Tz1: Mapped[int] = mapped_column('Tz1', default=0)
    Tz2: Mapped[int] = mapped_column('Tz2', default=0)
    Tz3: Mapped[int] = mapped_column('Tz3', default=0)
    Tz4: Mapped[int] = mapped_column('Tz4', default=0)
...
class DGRP(AcsDataBase):
    ...
    DGrp: Mapped[int] = mapped_column('DGrp', default=0)
    DlFlag: Mapped[int] = mapped_column('DlFlag', nullable=True, default=0)
    D0: Mapped[bool] = mapped_column('D0', default=False)
    D1: Mapped[bool] = mapped_column('D1', default=False)
    D2: Mapped[bool] = mapped_column('D2', default=False)
    D3: Mapped[bool] = mapped_column('D3', default=False)
    D4: Mapped[bool] = mapped_column('D4', default=False)
    D5: Mapped[bool] = mapped_column('D5', default=False)
    D6: Mapped[bool] = mapped_column('D6', default=False)
    D7: Mapped[bool] = mapped_column('D7', default=False)
    D8: Mapped[bool] = mapped_column('D8', default=False)
    D9: Mapped[bool] = mapped_column('D9', default=False)
    D10: Mapped[bool] = mapped_column('D10', default=False)
    D11: Mapped[bool] = mapped_column('D11', default=False)
    D12: Mapped[bool] = mapped_column('D12', default=False)
    D13: Mapped[bool] = mapped_column('D13', default=False)
    D14: Mapped[bool] = mapped_column('D14', default=False)
    D15: Mapped[bool] = mapped_column('D15', default=False)
    D16: Mapped[bool] = mapped_column('D16', default=False)
    D17: Mapped[bool] = mapped_column('D17', default=False)
    D18: Mapped[bool] = mapped_column('D18', default=False)
    D19: Mapped[bool] = mapped_column('D19', default=False)
    D20: Mapped[bool] = mapped_column('D20', default=False)
    D21: Mapped[bool] = mapped_column('D21', default=False)
    D22: Mapped[bool] = mapped_column('D22', default=False)
    D23: Mapped[bool] = mapped_column('D23', default=False)
    D24: Mapped[bool] = mapped_column('D24', default=False)
    D25: Mapped[bool] = mapped_column('D25', default=False)
    D26: Mapped[bool] = mapped_column('D26', default=False)
    D27: Mapped[bool] = mapped_column('D27', default=False)
    D28: Mapped[bool] = mapped_column('D28', default=False)
    D29: Mapped[bool] = mapped_column('D29', default=False)
    D30: Mapped[bool] = mapped_column('D30', default=False)
    D31: Mapped[bool] = mapped_column('D31', default=False)
    D32: Mapped[bool] = mapped_column('D32', default=False)
    D33: Mapped[bool] = mapped_column('D33', default=False)
    D34: Mapped[bool] = mapped_column('D34', default=False)
    D35: Mapped[bool] = mapped_column('D35', default=False)
    D36: Mapped[bool] = mapped_column('D36', default=False)
    D37: Mapped[bool] = mapped_column('D37', default=False)
    D38: Mapped[bool] = mapped_column('D38', default=False)
    D39: Mapped[bool] = mapped_column('D39', default=False)
    D40: Mapped[bool] = mapped_column('D40', default=False)
    D41: Mapped[bool] = mapped_column('D41', default=False)
    D42: Mapped[bool] = mapped_column('D42', default=False)
    D43: Mapped[bool] = mapped_column('D43', default=False)
    D44: Mapped[bool] = mapped_column('D44', default=False)
    D45: Mapped[bool] = mapped_column('D45', default=False)
    D46: Mapped[bool] = mapped_column('D46', default=False)
    D47: Mapped[bool] = mapped_column('D47', default=False)
    D48: Mapped[bool] = mapped_column('D48', default=False)
    D49: Mapped[bool] = mapped_column('D49', default=False)
    D50: Mapped[bool] = mapped_column('D50', default=False)
    D51: Mapped[bool] = mapped_column('D51', default=False)
    D52: Mapped[bool] = mapped_column('D52', default=False)
    D53: Mapped[bool] = mapped_column('D53', default=False)
    D54: Mapped[bool] = mapped_column('D54', default=False)
    D55: Mapped[bool] = mapped_column('D55', default=False)
    D56: Mapped[bool] = mapped_column('D56', default=False)
    D57: Mapped[bool] = mapped_column('D57', default=False)
    D58: Mapped[bool] = mapped_column('D58', default=False)
    D59: Mapped[bool] = mapped_column('D59', default=False)
    D60: Mapped[bool] = mapped_column('D60', default=False)
    D61: Mapped[bool] = mapped_column('D61', default=False)
    D62: Mapped[bool] = mapped_column('D62', default=False)
    D63: Mapped[bool] = mapped_column('D63', default=False)
    D64: Mapped[bool] = mapped_column('D64', default=False)
    D65: Mapped[bool] = mapped_column('D65', default=False)
    D66: Mapped[bool] = mapped_column('D66', default=False)
    D67: Mapped[bool] = mapped_column('D67', default=False)
    D68: Mapped[bool] = mapped_column('D68', default=False)
    D69: Mapped[bool] = mapped_column('D69', default=False)
    D70: Mapped[bool] = mapped_column('D70', default=False)
    D71: Mapped[bool] = mapped_column('D71', default=False)
    D72: Mapped[bool] = mapped_column('D72', default=False)
    D73: Mapped[bool] = mapped_column('D73', default=False)
    D74: Mapped[bool] = mapped_column('D74', default=False)
    D75: Mapped[bool] = mapped_column('D75', default=False)
    D76: Mapped[bool] = mapped_column('D76', default=False)
    D77: Mapped[bool] = mapped_column('D77', default=False)
    D78: Mapped[bool] = mapped_column('D78', default=False)
    D79: Mapped[bool] = mapped_column('D79', default=False)
    D80: Mapped[bool] = mapped_column('D80', default=False)
    D81: Mapped[bool] = mapped_column('D81', default=False)
    D82: Mapped[bool] = mapped_column('D82', default=False)
    D83: Mapped[bool] = mapped_column('D83', default=False)
    D84: Mapped[bool] = mapped_column('D84', default=False)
    D85: Mapped[bool] = mapped_column('D85', default=False)
    D86: Mapped[bool] = mapped_column('D86', default=False)
    D87: Mapped[bool] = mapped_column('D87', default=False)
    D88: Mapped[bool] = mapped_column('D88', default=False)
    D89: Mapped[bool] = mapped_column('D89', default=False)
    D90: Mapped[bool] = mapped_column('D90', default=False)
    D91: Mapped[bool] = mapped_column('D91', default=False)
    D92: Mapped[bool] = mapped_column('D92', default=False)
    D93: Mapped[bool] = mapped_column('D93', default=False)
    D94: Mapped[bool] = mapped_column('D94', default=False)
    D95: Mapped[bool] = mapped_column('D95', default=False)
    D96: Mapped[bool] = mapped_column('D96', default=False)
    D97: Mapped[bool] = mapped_column('D97', default=False)
    D98: Mapped[bool] = mapped_column('D98', default=False)
    D99: Mapped[bool] = mapped_column('D99', default=False)
    D100: Mapped[bool] = mapped_column('D100', default=False)
    D101: Mapped[bool] = mapped_column('D101', default=False)
    D102: Mapped[bool] = mapped_column('D102', default=False)
    D103: Mapped[bool] = mapped_column('D103', default=False)
    D104: Mapped[bool] = mapped_column('D104', default=False)
    D105: Mapped[bool] = mapped_column('D105', default=False)
    D106: Mapped[bool] = mapped_column('D106', default=False)
    D107: Mapped[bool] = mapped_column('D107', default=False)
    D108: Mapped[bool] = mapped_column('D108', default=False)
    D109: Mapped[bool] = mapped_column('D109', default=False)
    D110: Mapped[bool] = mapped_column('D110', default=False)
    D111: Mapped[bool] = mapped_column('D111', default=False)
    D112: Mapped[bool] = mapped_column('D112', default=False)
    D113: Mapped[bool] = mapped_column('D113', default=False)
    D114: Mapped[bool] = mapped_column('D114', default=False)
    D115: Mapped[bool] = mapped_column('D115', default=False)
    D116: Mapped[bool] = mapped_column('D116', default=False)
    D117: Mapped[bool] = mapped_column('D117', default=False)
    D118: Mapped[bool] = mapped_column('D118', default=False)
    D119: Mapped[bool] = mapped_column('D119', default=False)
    D120: Mapped[bool] = mapped_column('D120', default=False)
    D121: Mapped[bool] = mapped_column('D121', default=False)
    D122: Mapped[bool] = mapped_column('D122', default=False)
    D123: Mapped[bool] = mapped_column('D123', default=False)
    D124: Mapped[bool] = mapped_column('D124', default=False)
    D125: Mapped[bool] = mapped_column('D125', default=False)
    D126: Mapped[bool] = mapped_column('D126', default=False)
    D127: Mapped[bool] = mapped_column('D127', default=False)
    CkSum: Mapped[int] = mapped_column('CkSum', nullable=True, default=0)
...
class LocCards(AcsDataBase):
    ...
    ID: Mapped[int] = mapped_column('ID', primary_key=True, nullable=True)
    CardID: Mapped[int] = mapped_column('CardID', ForeignKey('CARDS.ID'), default=0)
    Loc: Mapped[int] = mapped_column('Loc', ForeignKey('LOC.Loc'), default=1)
